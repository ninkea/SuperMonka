...
namespace fly
{
    [BepInPlugin("org.XenomVR.monkeytag.SuperMonka", "SuperMonka", "VERSION 0.0.0.1")]
    public class MyPatcher : BaseUnityPlugin
    {
        public void Awake()
        {
            var harmony = new Harmony("com.XenomVR.monkeytag.HOW TO USE");
    ...
    public class Class1
    {
        ...
        static void Postfix(GorillaLocomotion.Player __instance)
        {
            ...
            if (!PhotonNetwork.CurrentRoom.IsVisible || !PhotonNetwork.InRoom)
            {
                ...
                list[0].TryGetFeatureValue(CommonUsages.gripButton, out body);
